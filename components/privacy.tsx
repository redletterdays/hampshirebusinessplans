            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-8 font-open-sans text-base text-body-color">
                  ...
                  that is collected and recorded by Hampshire Business Plans and
                  how we use it.
                </p>
                <p className="mb-8 font-open-sans text-base text-body-color">
                ...
                <p className="mb-8 font-open-sans text-base text-body-color">
                  ...
                  information that they shared and/or collect in Hampshire
                  Business Plans This policy is not applicable to any
                ...
                <p className="mb-5 font-open-sans text-base text-body-color">
                  Hampshire Business Plans follows a standard procedure of using
                  log files.
                </p>
                <p className="mb-8 font-open-sans text-base text-body-color">
                ...
                <p className="mb-5 font-open-sans text-base text-body-color">
                  Like any other website, Hampshire Business Plans uses
                  'cookies'.
                </p>
                <p className="mb-8 font-open-sans text-base text-body-color">
                ...
                <p className="mb-5 font-open-sans text-base text-body-color">
                  ...
                  of the advertising partners of Hampshire Business Plans{" "}
                </p>
                <p className="mb-8 font-open-sans text-base text-body-color">
                  Third-party ad servers or ad networks uses technologies like
                  cookies, JavaScript, or Web Beacons that are used in their
                  respective advertisements and links that appear on Hampshire '
                  Business Plans, which are sent directly to users' browser.
                </p>
                <p className="mb-8 font-open-sans text-base text-body-color">
                ...
                <p className="mb-8 font-open-sans text-base text-body-color">
                  Note that Hampshire Business Plans has no access to or control
                ...
                <p className="mb-5 font-open-sans text-base text-body-color">
                  Hampshire Business Plans Privacy Policy does not apply to
                ...
                <p className="mb-8 font-open-sans text-base text-body-color">
                  Hampshire Business Plans does not knowingly collect any
